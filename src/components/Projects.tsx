...
Users can only access course content after payment, ensuring a secure and personalized learning experience.`,
    ...
    {
      title: "Landing Page",
      description: "A modern and responsive landing page built with HTML, Tailwind CSS, and vanilla JavaScript.The design is clean and minimalistic, featuring smooth layout, consistent color palette, and optimized for all screen sizes.This project demonstrates my ability to create structured, mobile- friendly web interfaces using utility - first CSS and custom scripting.",
      technologies: ["HTML5", "Tailwind CSS", "JavaScript (Vanilla JS)"],
      github: "https://github.com/kha121ham/Landing-Page",
      live: "https://landing-page-three-sigma-41.vercel.app/",
      featured: false,
      image: "/Screenshot 2025-07-06 175122.png"
    }
  ];
