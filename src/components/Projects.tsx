      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="bg-slate-700/50 rounded-xl p-6 hover:bg-slate-700 transition-all duration-300 hover:scale-105 group relative overflow-hidden"
            >
              {project.featured && (
              ...
              <div className="w-full h-48 bg-gradient-to-br from-indigo-500/20 to-purple-600/20 rounded-lg mb-6 flex items-center justify-center">
                <div className="text-4xl text-indigo-400 opacity-50">💻</div>
              </div>
        ...
        <div className="text-center mt-12">
          <a
            href="#"
            className="inline-flex items-center gap-2 px-8 py-3 border-2 border-indigo-400 text-indigo-400 rounded-full hover:bg-indigo-400 hover:text-white transition-all duration-300 font-semibold"
          >
            <Github size={20} />
