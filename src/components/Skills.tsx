      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <div key={categoryIndex} className="bg-white dark:bg-slate-800/50 p-8 rounded-xl shadow-sm dark:shadow-none">
              <h3 className="text-2xl font-bold text-indigo-500 dark:text-indigo-400 mb-6 text-center">
                {category.title}
              </h3>
